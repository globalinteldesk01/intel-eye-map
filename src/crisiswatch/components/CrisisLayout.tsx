...
import {
  LayoutDashboard, Map, Building2, Users, Bell, ShieldAlert, FileText, Settings, LogOut, Menu, X, Activity, Bot, Plane, Globe2, CloudRain, Radio
} from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { path: '/crisiswatch/tactical', label: 'Tactical Monitoring', icon: Radio },
